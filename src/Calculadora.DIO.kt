...
fun main ( ) {
    ...
    when (readLine()!!.toInt()) {
        1-> {
            ...
            when (operacao) {
                1-> {
                    println("O resultado da somatória é: " + soma(num1, num2))
                }
                2-> {
                    println("O resultado da subtração é: " + subtracao(num1, num2))
                }
                3-> {
                    println("O resultado da multiplicação é: " + multiplicacao(num1, num2))
                }
                4-> {
                    println("O resultado da divisão é: " + divisao(num1, num2))
                }
                5-> {
                    println("O resultado da porcentagem é: " + porcentagem(num1, num2))
                }
                6-> {
                    println("O resultado da potenciação é: " + potenciacao(num1, num2))
                }
                7-> {
                    println("Que pena que você decidiu sair! Volte logo. Saindo...")
                }
            }
        }
        2-> {
